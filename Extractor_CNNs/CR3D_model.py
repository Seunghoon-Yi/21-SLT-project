...
class CPlusR3D(nn.Module):
    def __init__(self, n_class, pretrained = False):
        super(CPlusR3D, self).__init__()
        ...
        # BS, 64, 56, 7, 6
        self.conv6 = nn.Conv3d(in_channels=64, out_channels=32, kernel_size=(1,1,1), padding=(0,0,0))
        #
        #self.fc6 = nn.Linear(64*7*6, 1024)
        self.fc7 = nn.Linear(32*7*6, n_class)
...
if __name__ == "__main__":
    ...
    net = CPlusR3D(n_class=512, pretrained=False)
